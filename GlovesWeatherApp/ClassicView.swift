   ...
   var data : Data
    ...
    var body: some View {
        ...
        ZStack{
            ...
            VStack{
                if temp < 21 {
              Text(coldColdFund.description)
                }
                else if temp > 20 && temp < 33{
                    Text(coldFund.description) }
                else if temp > 32 && temp < 51{
                    Text(coldishFund.description) }
                else if temp > 50 && temp < 61{
                     Text(warmishFund.description)}
                else if temp > 60 && temp < 71{
                     Text(coldColdFund.description)}
                else if (temp > 60 && temp < 71){
                     Text(hotFund.description)
                }
                else {
                    Text(hawtFund.description) //hawtComfy
                }
            }
